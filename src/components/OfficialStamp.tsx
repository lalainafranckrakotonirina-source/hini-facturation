 ...
 * Faithfully reproduces the official blue oval "HiNi Madagascar" stamp with authentic handwritten signature
 */
export const OfficialStamp: React.FC<OfficialStampProps> = ({
  ...
  return (
    <div className={`relative inline-block w-56 select-none pointer-events-none ${className}`}>
      {/* Container with SVG stamp and signature */}
        ...
        >
          ...
          <g filter="url(#stamp-roughness)">
            ...
            <g fill="#224b94" opacity="0.95">
              {/* Stylized 'H' */}
              <path
                d="M 68,44 L 88,44 L 62,94 L 42,94 Z"
              />
              <path
                d="M 60,65 L 105,65 L 98,76 L 55,76 Z"
              />
              <path
                d="M 94,44 L 114,44 L 88,94 L 68,94 Z"
              />
              {/* Center disc/accent inside H */}
          ...
          {showSignature && (
            <g
              ...
              opacity="0.96"
            >
              {/* Primary signature flourish loops extending down below oval */}
              {/* First loop and cross-cutting cursive ascender */}
              <path
